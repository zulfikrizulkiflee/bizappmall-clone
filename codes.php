...
?>
    ...
    <head>
        <title>Classic Style a Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Codes :: w3layouts</title>
        <!-- for-mobile-apps -->
    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="codes"> Codes</a></li>
        ...
        <div class="banner-top">
            <div class="container">
                ...
                <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="/Project%20BizApp/bizappmall">Home</a><label>/</label>Codes</h3>
                <div class="clearfix"> </div>
            </div>
        </div>
        <!-- contact -->

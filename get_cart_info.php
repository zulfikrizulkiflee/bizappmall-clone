...
if($action == "history"){
    $myArray = array();
    if ($result = $db->query("SELECT seller_id, product1, product2, product3, product4, product5, product6, product7, product8, product9, product10, quantity1, quantity2, quantity3, quantity4, quantity5, quantity6, quantity7, quantity8, quantity9, quantity10, price_sum, delivery_name, delivery_address1, delivery_address2, delivery_address3, delivery_postcode, delivery_state, checkin_date, emall_fpxurl, trackingno FROM comm_cart WHERE user_id='".$user_id."' AND checkout=1 ORDER BY checkin_date DESC")) {
        $tempArray = array();

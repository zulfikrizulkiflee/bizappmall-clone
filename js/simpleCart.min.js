        ...
        generateSimpleCart = function (space) {
            ...
            simpleCart.extend({
                ...
                save: function () {
                    ...
                    $.get(home + '/get_user_cart.php?action=update&uid=' + userID + '&cart_data=' + decodeURIComponent(JSON.stringify(items)), function (data) {
                        console.log(data);
                    });
            ...
            cartColumnViews = {
                ...
                checkbox: function (item, column) {
                    return "<label class='checkbox1'> <input type='checkbox' class='check-item' data-prodid='" + item.get('prodid') + "'><i style='bottom: -0.5em;'> </i></label>";
                },
            ...
            simpleCart.ready(function () {
                ...
                simpleCart.bind("afterCreate", function () {
                    ...
                    $("input:checkbox.check-item").each(function () {
                        if (count < limit) {
                    ...
                    $('input:checkbox.check-item').on('change', function (evt) {

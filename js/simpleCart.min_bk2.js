...
//                        }
            ...
            simpleCart.extend({
                ...
                save: function () {
                    ...
                    localStorage.setItem(appname + namespace + "_items", JSON.stringify(items));
                ...
                load: function () {
                    ...
                    var items = localStorage.getItem(appname + namespace + "_items");
                ...
                simpleCart.bindInputs([
					...
					, {
                        ...
                        callback: function () {
                            ...
                            $.each(cart_obj, function (i, cart_obj) {
                                if (cart_obj.pid == item_id) {
                                    count++;
                                }
                            });
